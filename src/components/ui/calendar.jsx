  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          'bg-red text-white hover:bg-red hover:text-white focus:bg-red focus:text-white',
        day_today: 'bg-accent text-accent-foreground',
        day_outside:
          'day-outside text-black opacity-50 aria-selected:bg-gray-50/50 aria-selected:text-black aria-selected:opacity-30',
